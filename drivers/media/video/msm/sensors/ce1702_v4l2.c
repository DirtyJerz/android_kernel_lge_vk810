...
int8_t ce1702_set_model_name(void)
{
	...
	data[0] = 0x06;	// Model
	data[1] = strlen(model_name)+1;/* LGE_CHANGE, Add "\0" at end of Model Name for fixing Google+ edit error, 2014.05.27, elin.lee@lge.com */
	...
	memset(data, 0, sizeof(data));
	data[0] = 0x05;	// Maker
	data[1] = strlen(maker_name)+1;/* LGE_CHANGE, Add "\0" at end of Maker Name for fixing Google+ edit error, 2014.05.27, elin.lee@lge.com */
